...
export default function ApprovedPages() {
    const [properties, setProperties] = useState([]);   
    useEffect(() => {
        // Fetch properties with status set to false
        axios.get('/api/property/statusChanged')
          .then(response => {
      ...
      return (
        <div className="container mx-auto mt-8 p-6 bg-gray-100 rounded-lg shadow-md">
          <h1 className="text-3xl font-semibold mb-4">Approved Property Page</h1>
              ...
              <tbody>
                {properties.map((property) => (
                  ...
                  />
                    ...
                    <td className="border border-gray-300 p-3">{property.title}</td>
